...
static const route_rule_t ROUTES[] = {
    ...
    {"/assets/xterm.js", HTTP_ROUTE_METHOD_GET, 0, HTTP_ROUTE_SECURITY_PUBLIC},
    {"/assets/xterm.css", HTTP_ROUTE_METHOD_GET, 0, HTTP_ROUTE_SECURITY_PUBLIC},
    ...
    {"/credentials", HTTP_ROUTE_METHOD_GET, 0, HTTP_ROUTE_SECURITY_AUTH_REQUIRED},
    {"/config", HTTP_ROUTE_METHOD_GET, 0, HTTP_ROUTE_SECURITY_AUTH_REQUIRED},
    {"/config.json", HTTP_ROUTE_METHOD_GET, 0, HTTP_ROUTE_SECURITY_AUTH_REQUIRED},
    {"/macros", HTTP_ROUTE_METHOD_GET, 0, HTTP_ROUTE_SECURITY_AUTH_REQUIRED},
    {"/api/emergency-lock", HTTP_ROUTE_METHOD_POST, 0, HTTP_ROUTE_SECURITY_MUTATING_AUTH_CSRF_ORIGIN},
    ...
    {"/api/credentials/rotate", HTTP_ROUTE_METHOD_POST, 0, HTTP_ROUTE_SECURITY_MUTATING_AUTH_CSRF_ORIGIN},
    {"/api/config/import", HTTP_ROUTE_METHOD_POST, HTTP_ROUTE_CONFIG_IMPORT_BODY_MAX, HTTP_ROUTE_SECURITY_MUTATING_AUTH_CSRF_ORIGIN},
    {"/api/demo/start", HTTP_ROUTE_METHOD_POST, 0, HTTP_ROUTE_SECURITY_MUTATING_AUTH_CSRF_ORIGIN},
    {"/api/demo/stop", HTTP_ROUTE_METHOD_POST, 0, HTTP_ROUTE_SECURITY_MUTATING_AUTH_CSRF_ORIGIN},
    {"/api/macros/run", HTTP_ROUTE_METHOD_POST, HTTP_ROUTE_MACRO_RUN_BODY_MAX, HTTP_ROUTE_SECURITY_MUTATING_AUTH_CSRF_ORIGIN},
