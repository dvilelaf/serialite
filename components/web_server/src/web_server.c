...
static esp_err_t terminal_handler(httpd_req_t *req)
{
    ...
    ESP_RETURN_ON_ERROR(send_terminal_format_chunk(req,
        ...
        "@media(max-width:640px){#hud{right:8px;top:8px;gap:6px;padding:6px}.pill{font-size:11px;padding:5px 7px}button{padding:7px 9px}button.round{width:32px;height:32px;padding:0}#terminal{padding:12px 12px 76px;font-size:13px}}"
