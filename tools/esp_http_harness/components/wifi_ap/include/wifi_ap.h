...
typedef struct { char ssid[WIFI_AP_SSID_MAX_LEN]; char password[WIFI_AP_PASSWORD_MAX_LEN]; uint8_t channel; uint8_t max_clients; } kvm_wifi_ap_config_t;
typedef struct { char ip_addr[16]; uint8_t connected_clients; bool started; } wifi_ap_status_t;
